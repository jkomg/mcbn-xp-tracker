...
const envSchema = z.object({
  ...
  RUMOR_APPROVAL_ENABLED: z.string().optional(),
  RUMOR_EXPIRY_INTERVAL_MS: z.string().optional(),
  ...
  RETAINER_SHEETS_CHANNEL_ID: z.string().optional(),
...
export const config = {
  ...
  rumorApprovalEnabled: (env.RUMOR_APPROVAL_ENABLED ?? 'false').toLowerCase() === 'true',
  rumorExpiryIntervalMs: parsePositiveInt(env.RUMOR_EXPIRY_INTERVAL_MS, 600_000, 'RUMOR_EXPIRY_INTERVAL_MS'),
  ...
  retainerSheetsChannelId: env.RETAINER_SHEETS_CHANNEL_ID ?? '1199460154714882188',
